...
const ServicePage = ({ t }: { t: any }) => {
  const { services, activeService, markService, getService } = useContext(ServicesContext);
  ...
  const { is_marked, title, references, description } = currentService || {};
    ...
    currentService && (
      <div className="service--page">
        <div className="flex justify-space-b">
          <div className="flex f-col">
            ...
            <div className="service--page__icons flex gap">
              <CustomButton icon onClick={() => markService(!is_marked, Id)}>
                <BookmarkIcon className={is_marked ? 'service--page__icon active' : 'service--page__icon'} />
              </CustomButton>
          ...
          {references?.length && (
            <div className="service--page__reference flex gap justify-end">
